$(function() {
  ...
  $(document).on('click', '.chat-group-user__btn--add', function() {
    ...
    var add_item = `<li class="list select_member" user_id="${add_id}" user_name="${add_name}">${add_name}<span class="chat-group-user__btn--remove">削除</span><input type="hidden", name="group[user_ids][]", value="${add_id}"></li>`;
